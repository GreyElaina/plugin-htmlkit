...
namespace cairo_wrapper
{
    ...
    private:
        ...
        static void cairo_add_path_arc(cairo_t* cr, double x, double y, double rx, double ry, double a1, double a2,
                                       bool neg);
    ...
    namespace conic_gradient
    {
        ...
        static void sector_patch(cairo_pattern_t* pat, double radius, double angle_A, const litehtml::web_color& A,
                                 double angle_B, const litehtml::web_color& B);
